...
var strReplace = strObj.str.replace('ыла раму, рама мыла', 'оет раму, Рама держит');
...
var myOwnString = 'Мне в окошко постучал сентябрь багряной веткой ивы';
console.log(myOwnString.toUpperCase());
console.log(myOwnString.toLowerCase());